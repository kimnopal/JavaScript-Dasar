...
function createTodoElement(value) {
    ...
    // Menyelipkan element a kedalam children li
    li.appendChild(a);

    // Memasukkan element li yang telah dibuat dengan javasript kedalam element todolist
